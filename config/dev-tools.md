...
- [rust 圣经](https://course.rs/basic/variable.html)
- [rust 练习](https://zh.practice.rs/variables.html#%E7%BB%91%E5%AE%9A%E5%92%8C%E5%8F%AF%E5%8F%98%E6%80%A7)
...
- [javascript 练习](https://exercism.org/tracks/javascript/concepts/basics)
...
- [网址导航](https://hao.uisdc.com/)

## AI

- <https://yige.baidu.com/>
- [Logo 生成](https://looka.com/onboarding)

## Other

- [star history](https://star-history.com/#facebook/react&Date)

[builder](https://www.builder.io/)

- [vscode AI 提示插件 codeium](https://codeium.com/profile)

- [caniuse](https://caniuse.com/)

- [图片去除背景](https://www.remove.bg/zh)
- [图片排版](https://unsplash.com/)
- [正则可视化](https://jex.im/regulex/)
- [流程图](https://www.iodraw.com/)
- [插图](https://www.iodraw.com/)
- [图标](https://lucide.dev/)
- [color 颜色](https://colorhunt.co/)
- [图片压缩](https://tinypng.com/)
